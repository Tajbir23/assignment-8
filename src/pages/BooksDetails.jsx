      ...
      <div className="my-10 mx-6 flex sm:flex-row flex-col gap-8">
        ...
        <div>
          ...
          <div className="mt-5">
            ...
            {dataArray?.tags?.map((tag, index) => (
              <span
                key={index}
                className="inline-block text-[#23BE0A] bg-[#23BE0A0D] text-sm px-2 py-1 rounded-full mr-2 mb-2 font-medium"
              >
                #{tag}
              </span>
            ))}
          ...
          <div className="mt-5 flex gap-2">
            <button
              onClick={() => readBook()}
              className="btn bg-[#50B1C9] hover:bg-transparent"
            >
              Read
            </button>
            <button
